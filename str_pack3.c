...
/**
* stringconcatenate_byn - Concatenate two strings, with a limit of 'n' charac
* ters.
...
*
* * Description: This function searches for the first occurrence of the charact
* er
* 'c' in the string 's'.
*
* * Return: A pointer to the first occurrence of 'c' in 's', or NULL if not fou
* nd.
*/

 ...
 * @destinate: Pointer to the destination string where the content is to be copied.
 ...
 *
 * Return: Pointer to the duplicated string. It returns NULL if insufficient memory was available.
 */

...
/**
 * delim_chain_checker - checks if the current character in the buffer is a chain delimiter
...
/**
 * chain_checker - checks if we should continue chaining based on the last status
 * @info: the parameter struct
 * @buf: the character buffer
 * @p: address of the current position in buf
